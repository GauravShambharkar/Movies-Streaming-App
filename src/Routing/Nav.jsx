      ...
      <div className="rightSIde flex w-full border-white justify-end ">
        <div className="flex flex-row items-center gap-3 px-2  border-white" >
            ...
            <NavLink to='/' className={({isActive})=>{
              return isActive? "text-[#a2c9ff]  items-center flex gap-2 text-[13px] " : "text-[#ffffff] items-center text-[13px] flex gap-2"
            }}>
              Home</NavLink>
            <NavLink to='/trending' className={({isActive})=>{
              return isActive? "text-[#a2c9ff] flex gap-2 items-center text-[13px]" : "text-[#ffffff] items-center flex text-[13px] gap-2"
            }}  >
              Trending</NavLink>
