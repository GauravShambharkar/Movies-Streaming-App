...
const Popular = () => {
  ...
  return (
    <div className="w-full  border backdrop-blur-sm py-2 flex flex-col border-white justify-center items-center gap-8 ">
      ...
      {/* Trending banner */}
      {showPopularBanner ? (<div className="banner  text-white border-white w-250 rounded-2xl h-120 mt-20 bg-cover bg-center max-lg:w-150 max-lg:h-90 max-md:w-70 max-md:h-45"
        style={{
      ...
      <div className="w-full h-full flex gap-2 flex-col justify-end  border-white p-4 max-md:text-[10px]">
        ...
        <h1 className="text-4xl font-bold text-[#f7ff66] max-md:text-[10px]" >{showPopularBanner.name || showPopularBanner.title || showPopularBanner.original_name || showPopularBanner.original_title }</h1>
