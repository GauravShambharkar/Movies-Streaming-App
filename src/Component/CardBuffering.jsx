  ...
  return (
    <>
      {[1, 2, 3, 4, 5, 6, 7, 8].map((item,id) => {
        return (
          <div key={id} className="hover:scale-101 w-full h-70 flex flex-col justify-between gap-2 rounded-2xl  border-[#ffffff] bg-[#1e1e1e] p-4 shadow-lg transition-transform duration-200">
            {/* top of the card */}
